...
public class AturanEditActivity extends AppCompatActivity {
    ...
    private static final String url = "http://192.168.235.48/sp_bawangmerah/get_daftar_gejala.php";
    private static final String url_update = "http://192.168.235.48/sp_bawangmerah/update_aturan.php";

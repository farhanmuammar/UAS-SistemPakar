...
public class GejalaEditActivity extends AppCompatActivity {
    ...
    private static final String url = "http://192.168.235.48/sp_bawangmerah/get_gejala.php";
    private static final String url_update = "http://192.168.235.48/sp_bawangmerah/update_gejala.php";
    private static final String url_delete = "http://192.168.235.48/sp_bawangmerah/delete_gejala.php";

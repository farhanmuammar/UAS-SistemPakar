package com.sistempakarbawangmerah.admin;
...
import com.sistempakarbawangmerah.MySingleton;
...
public class PenyakitEditActivity extends AppCompatActivity {
    ...
    private static final String url = "http://192.168.235.48/sp_bawangmerah/get_penyakit.php";
    private static final String url_update = "http://192.168.235.48/sp_bawangmerah/update_penyakit.php";
    private static final String url_delete = "http://192.168.235.48/sp_bawangmerah/delete_penyakit.php";
